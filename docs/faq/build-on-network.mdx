...
Hotspots create LoRaWAN coverage, with sub-ghz unlicensed spectrum that varies country by country.  You can [view the frequency used per country here](https://docs.helium.com/lorawan-on-helium/frequency-plans).
